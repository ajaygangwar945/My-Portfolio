...
<p align="justify">
I am an <b>Aspiring Data Scientist</b> and <b>Full Stack Developer</b> passionate about transforming raw data into intelligent, actionable insights. Currently pursuing my Bachelor of Technology in Computer Science at <b>Lovely Professional University</b>, I specialize in bridging the gap between elegant engineering and data-driven decision making.
</p>
...
1. **Clone & Enter Directory**
   ...
   ```bash
   git clone https://github.com/ajaygangwar945/My-Portfolio.git
   cd My-Portfolio
   ```
...
3. **Configure Environment**
   Create a `.env` file in the root and add your [Gemini API Key](https://aistudio.google.com/app/apikey):
